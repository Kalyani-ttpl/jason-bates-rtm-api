...
export class AuthService extends BaseService {
  ...
  /**
   * Authenticates a provider against a tenant identified by slug and returns
   * access and refresh tokens plus the provider's profile and groups.
   */
  async login(loginDto: LoginDto) {
    const tenant = await this.tenantService.findActiveBySlug(loginDto.tenant);
